...
$bookmarks = [
    ...
    'ProgramInsightText' => 'Employer engagement proved most effective when employers became involved before the formal recruitment stage rather than only receiving completed candidate profiles.',
