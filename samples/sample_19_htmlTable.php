...
$template = new OdtTemplate(__DIR__ . '/templates/template_19_htmlTable.odt');
...
<table>
    ...
    <strong><span style="color:#008000;">Active</span></strong>
</td>
</td>
        </tr>
        <tr>
...
$template->save(__DIR__ . '/output/output_19_htmlTable.odt');
