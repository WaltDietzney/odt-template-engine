...
$para->addText('This text is normal color but bold ', ['bold' => true])
    ...
    ->addText('$image = new ImageElement(\'path\toFile\') ', ['italic' => true, 'color' => '#db250d','font-family'=>'Courier New', 'background-color'=>'#D3D3D3'])
    ->addLineBreak(3)
    ->addText('Then add the image to the paragraph with ')
    ->addText('$para->addElement($image)', ['italic' => true, 'color' => '#db250d','font-family'=>'Courier New', 'background-color'=>'#D3D3D3'])
    ->addText(' method.')
    ->addLineBreak(2)
