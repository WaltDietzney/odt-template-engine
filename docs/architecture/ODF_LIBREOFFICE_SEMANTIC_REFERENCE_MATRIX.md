...
| TABLE-02 | `TABLE-02-formatted-cell.odt` | Automatic table/table-column/table-row/table-cell styles are in `content.xml`; cell A1 owns background/padding/border and paragraph P1 owns centered alignment, text color, and bold. | 10,283 bytes; SHA-256 `54faedde6930b7812bec91a7fca3aca727128f34b1483e9b7e15027f30444765` |
