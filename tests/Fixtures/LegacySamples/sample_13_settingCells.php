...
$financeTable = (new RichTable())->buildTableFromArray($tableData1, 'marketing');
...
$rich->addParagraph('Sample 13: Advanced Table Construction','Title')
...
echo "✔️ Successfully created test ODT: tests/Fixtures/LegacySamples/output/output_13_settingCells.odt\n";
