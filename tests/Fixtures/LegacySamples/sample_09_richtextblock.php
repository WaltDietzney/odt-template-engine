<?php
/**
 * Example Script: RichText Block with Mixed Styles, Tabs, and Lists
 *
 * Description:
 * This example demonstrates how to use the OdtTemplateEngine to build a complex
 * RichText block with inline styles (bold, italic, colored), hyperlinks, line breaks,
 * tab characters, tab-stop-based columns, bullet and numbered lists, and custom
 * paragraph styles. The content replaces a {{CONTENT}} placeholder in the template.
 *
 * Requirements:
 * - OdtTemplateEngine (https://github.com/...)
 * - Template: tests/Fixtures/LegacySamples/templates/template_09_richtextblock.odt
 *
 * Output:
 * - tests/Fixtures/LegacySamples/output/output_09_richtextblock.odt
 *
 * Author: Walter Dietz
 * Date: 2025-04-29
 */
...
echo "✅ tests/Fixtures/LegacySamples/output/output_09_richtextblock.odt generated successfully\n";
